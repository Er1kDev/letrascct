  ...
  return (
    <Router >
      <section className="min-h-screen bg-gradient-to-b from-blue-700 to-slate-900" >
        <h1 className="text-center text-white py-16 drop-shadow-xl text-4xl font-medium">Alabanzas Comunidad Cristiana Talca</h1>
        <div className="text-white">
          <div className="container mx-auto max-w-5xl">
            <Routes>
              <Route path="/" element={
                <article>
                  <section className="flex justify-center py-10 drop-shadow-xl">
